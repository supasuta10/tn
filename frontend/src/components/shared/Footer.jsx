...
const Footer = () => {
    return (
        <footer className="footer footer-horizontal footer-center bg-green-50 text-green-700 p-10 border-t border-green-200">

            {/* Links */}
            <nav className="grid grid-flow-col gap-6">
                <Link to="/" className="link link-hover text-green-700">หน้าแรก</Link>
                <Link to="/booking" className="link link-hover text-green-700">จองโต๊ะจีน</Link>
                <Link to="/menu" className="link link-hover text-green-700">เมนูอาหาร</Link>
                <Link to="/contact" className="link link-hover text-green-700">ติดต่อร้าน</Link>
            </nav>
            ...
            {/* Copyright */}
            <aside className="text-green-700">
                <p>
                    © {new Date().getFullYear()} ชัยเจริญโภชนา — ระบบจองโต๊ะจีนออนไลน์
                </p>
            </aside>
        </footer>
    )
